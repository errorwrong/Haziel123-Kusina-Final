	...
	<div class="container">
		<form action="order.php" method="POST">
			...
			<div class="container">
				...
				<li class="breadcrumb-item"><a href="customer.php">Display Customer's</a></li>
			</ol>
		</nav>
	</form>
<br>
			...
			<?php require_once 'process.php'; ?>	
				...
				<h2><strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C U S T O M E R </strong></h2><br/>
					...
					<?php 
						if ($update == true):
					?>	
						<input class="btn btn-danger btn-lg btn-block" type="submit" name="update" value="update" >
					<?php else: ?>
						<input class="btn btn-danger btn-lg btn-block" type="submit" name="add" value="save" >
					<?php endif ;?>
				</form>
			</center>	
		</div>						
