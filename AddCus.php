	...
	<center>
		...
		<form action="order.php" method="POST">
			<div class="container">
				...
				<li class="breadcrumb-item"><a href="orders.php">Display Order's</a></li>
			</ol>
		</nav>
	</form>
<br>
		...
		<tr>
			...
			<br>
				<?php 
					if ($update == true):
				?>
					<input class="btn btn-danger btn-lg btn-block type="submit" name="update_order" value="update" >
				<?php else: ?>
					<input class="btn btn-danger btn-lg btn-block" type="submit" name="submit" value="save" >
				<?php endif ;?>
			</form>
		</center>
	</div>
